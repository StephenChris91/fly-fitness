...
export default function Home() {
    ...
    return (
        <>
            ...
            />
            <div className="pt-20">
                <div className="mx-auto flex flex-col lg:items-center sm:items-center lg:justify-between sm:justify-between lg:w-[1200px] sm:w-[400px] sm:p-5">
                    <h1 className="text-4xl mb-20 lg:text-center sm:text-left mx-auto font-bold">OUR TRAINING PROGRAMS</h1>
                    <div className="flex lg:flex-row sm:flex-col items-center justify-between mx-auto lg:mb-32 sm:mb-10">
                        <animated.div className="lg:mr-80 sm:mr-[200px] lg:mb-0 sm:mb-12" style={fadeInPropsLeft}>
                    ...
                    <div className="flex lg:flex-row sm:flex-col-reverse items-center justify-between mx-auto lg:mb-32 sm:mb-10">
                        ...
                        <animated.div className="lg:ml-80 sm:ml-[-200px] lg:mb-0 sm:mb-12" style={fadeInPropsRight}>
                    ...
                    <div className="flex lg:flex-row sm:flex-col-reverse items-center justify-between mx-auto lg:mb-32 sm:mb-10">
                        ...
                        <animated.div className="w-60 lg:ml-80 sm:ml-[0px] lg:mb-0 sm:mb-12" style={fadeInPropsRight}>
                            <Box imageUrl={Image8}></Box>
                        </animated.div>
                    </div>
                </div>
                <div className="pricing-section p-32 flex flex-col items-center justify-between bg-red-50 lg:w-[1200px] sm:w-[400px]">
                ...
                <div className="flex lg:flex-row sm:flex-col items-center lg:justify-between sm:justify-center lg:mx-0 sm:mx-auto lg:py-20 sm:py-20 lg:px-64 sm:px-10 bg-gray-200 lg:w-[1200px] sm:w-[400px]">
                    <h1 className="text-4xl font-bold text-center lg:mt-32 sm:mt-0 lg:mb-0 sm:mb-10">Meet Our Team</h1>
                    <Slider />
                </div>
